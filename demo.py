...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_path', type=str, default="output/degraded/", help='output save path')
    parser.add_argument('--ckpt_name', type=str, default="model.ckpt", help='checkpoint save path')
    parser.add_argument('--tile',type=bool,default=True,help="Set it to use tiling")
    parser.add_argument('--tile_size', type=int, default=64, help='Tile size (e.g 720). None means testing on the original resolution image')
